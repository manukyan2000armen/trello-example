    ...
    <div className={st.myRegister}>
        <div className={st.registerForm}>
            ...
            {errors.surname && <p className="text-danger">{errors.surname.message}</p>}
                    ...
                    <div>
                      ...
                      type="text"
                       {...register("email", {
                      required: "Լրացնել դաշտը",
                      pattern:{value:/^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/ , message:"Լրացնել Email-ի հստակ կառուցվածքին համապատասխան"}
              })}
            />
            {errors.email && <p className="text-danger">{errors.email.message}</p>}
              ...
              type="text"
              {...register("password", { required: "Լրացնել դաշտը",
              pattern:{value:/(?=.*\d)/,message:"Լրացնել տառեր,թվեր"}
             })}
             />
